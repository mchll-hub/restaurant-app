                ...
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="process/proses_inputmenu.php"
            ...
            <div class="modal fade" id="ModalView<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="process/proses_inputmenu.php" method="POST"
            ...
            <div class="modal fade" id="ModalEdit<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="process/proses_editmenu.php"
                                method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="ModalDelete<?php echo $row['id'] ?>" tabindex="-1"
                ...
                <div class="modal-dialog modal-md modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="process/proses_deletemenu.php" method="POST">
                                <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                <div class="col-lg-12">
