                    ...
                    <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="process/proses_terima_orderitem.php"
                                    method="POST">
                ...
                <div class="modal fade" id="siapsaji<?php echo $row['id_list_order'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="process/proses_siapsaji_orderitem.php"
                                    method="POST">
                                    <input type="hidden" name="id" value="<?php echo $row['id_list_order'] ?>">
                                    <div class="row">
                                        <div class="col-8">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button class="<?php echo (!empty ($row['status'])) ? "btn btn_secondary btn-sm me-1 disabled" : "btn btn-primary btn-sm me-1" ;?> " data-bs-toggle="modal"
                                                data-bs-target="#terima<?php echo $row['id_list_order'] ?>">Terima</button>
                                            <button class="<?php echo (empty ($row['status']) || $row['status'] != 1) ? "btn btn_secondary btn-sm  disabled" : "btn btn-success btn-sm" ;?>" data-bs-toggle="modal"
